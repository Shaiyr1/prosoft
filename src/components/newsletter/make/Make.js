...
function Make() {
    ...
    const handleSubmit = (event) => {
        ...
        console.log('Соцсеть/Почта:', selectedCountry);
        console.log('Тема:', subject);
        console.log('Сообщение:', message);
        console.log('Дата:', selectedDate);

        // Очистка полей после отправки
        setSelectedCountry('Выберите');
            ...
            <div className={style.make__blocks}>
                ...
                <div className={style.make__message}>
                    ...
                    <label>
                        ...
                        />
                        <div>
                            <button className={style.make__message_btn} type='submit' onClick={handleSubmit}>Отправить</button>
                            {showDateInput ? (
                                <input
                                    className={style.make__message_data}
                                    type="date"
